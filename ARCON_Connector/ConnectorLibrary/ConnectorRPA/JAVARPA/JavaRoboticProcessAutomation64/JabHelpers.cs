...
namespace JavaRoboticProcessAutomation64
{
    public static class JabHelpers
    {
        ...
        public static AccessibleTreeItem GetComponentTree(IntPtr hWnd, out Int32 vmID, out IntPtr acPtr)//string ConnectionName, string username, string password, string Hostname, string port, string sid,out Int32 vmID)
        {
            ...
            if (JAVARPA.isJavaWindow(hWnd) == 1)
            {
                unsafe
                {
                    //IntPtr acPtr;

                    if (JAVARPA.getAccessibleContextFromHWND(hWnd, out vmID, out acPtr))
                    {
                        ...
                        //#region SQL Developer Tested

                        //IntPtr ConnectionName = JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, acPtr, 0), 1), 0), 0), 0), 0), 0), 0), 2);
                        //IntPtr username = JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, acPtr, 0), 1), 0), 0), 0), 0), 0), 0), 4);
                        //IntPtr password = JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, acPtr, 0), 1), 0), 0), 0), 0), 0), 0), 6);

                        //IntPtr Hostname = JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID,
                        //JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, acPtr, 0), 1), 0), 0), 0), 0), 0), 0), 8), 0), 0), 1), 0), 1);


                        //IntPtr port = JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID,
                        //JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, acPtr, 0), 1), 0), 0), 0), 0), 0), 0), 8), 0), 0), 1), 0), 3);


                        //IntPtr sid = JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID,
                        //JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, JAVARPA.getAccessibleChildFromContext(vmID, acPtr, 0), 1), 0), 0), 0), 0), 0), 0), 8), 0), 0), 1), 0), 5);



                        //JAVARPA.setTextContents(vmID, ConnectionName, "Connection Name");
                        //JAVARPA.setTextContents(vmID, username, "Alok");
                        //JAVARPA.setTextContents(vmID, password, "Testpass12345");
                        //JAVARPA.setTextContents(vmID, Hostname, "10.10.1.117");
                        //JAVARPA.setTextContents(vmID, port, "8084");
                        //JAVARPA.setTextContents(vmID, sid, "123456");

                        //#endregion SQL Developer Tested End
        ...
        public static AccessibleContextInfo GetAccessibleContextInfo(Int32 vmID, IntPtr ac)
        {
            ...
            try
            {
                ...
                if (JAVARPA.getAccessibleContextInfo(vmID, ac, acPtr))
                {
        ...
        public static AccessibleTextItemsInfo GetAccessibleTextInfo(Int32 vmID, IntPtr ac)
        {
            ...
            //Call DLL.
            JAVARPA.getAccessibleTextItems(vmID, ac, ati, 0);
            //Creat object
        ...
        public static AccessibleTreeItem GetAccessibleContextInfo(Int32 vmID, IntPtr currentPtr, out AccessibleContextInfo currentContext, AccessibleTreeItem parentItem, int level, string lineage)
        {
            unsafe
            {
                ...
                try
                {
                    ...
                    Marshal.StructureToPtr(new AccessibleContextInfo(), acPtr, true);
                    if (JAVARPA.getAccessibleContextInfo(vmID, currentPtr, acPtr))
                    {
                            ...
                            if (!ReferenceEquals(newItem, null))
                            {
                                ...
                                for (int i = 0; i < currentContext.childrenCount; i++)
                                {
                                    ...
                                    if (currentContext.role_en_US != "unknown" && currentContext.states_en_US.Contains("visible")) // Note the optomization here, I found this get me to an acceptable speed
                                    {
                                        ...
                                        IntPtr childPtr = JAVARPA.getAccessibleChildFromContext(vmID, currentPtr, i);
                                        ...
                                        //JAVARPA.releaseJavaObject(vmID, childPtr);
                                    }
                ...
                finally
                {
                    ...
                    //TODO: Not sure when or where to release the java objects, the JVM will leak memory until released
                    //JAVARPA.releaseJavaObject(vmID, currentPtr);
                }
            }
            return null;
        }
