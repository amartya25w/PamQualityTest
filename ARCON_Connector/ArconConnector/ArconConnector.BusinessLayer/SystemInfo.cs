...
namespace ArconConnector.BusinessLayer
{
    ...
    public static class SystemInfo
    {
        ...
        public static OSVersionType OSVersionType
        {
            get
            {
                try
        ...
        public static OSBitType OSBitType
        {
            get
            {
                try
                {
                    if (Environment.GetEnvironmentVariable("PROCESSOR_ARCHITECTURE").ToString().IndexOf("64") > 0)
